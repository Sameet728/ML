...
def align_timeframes(
    ...
    # Shift 4H index forward by 3 hours so that a 4H bar starting at 04:00 (closing at 07:59:59)
    # is only merged into the 1H bar at 07:00 (which also closes at 07:59:59).
    # This completely eliminates look-ahead bias.
    df_4h_renamed.index = df_4h_renamed.index + pd.Timedelta(hours=3)
